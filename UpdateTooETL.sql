select xx.Plan_Number  ,xx.Plan_No,xx.Plan_mark,NULL as Plan_Remark
,xx.new_itinerary_resultid,xx.ownerid,xx.owner,xx.FormatDate,xx.Plan_Date ,xx.new_date     ,xx.Plan_Period  
,xx.Plan_Time   /*, xx.Plan_Activities*/,xx.Planner, xx.Plan_Activities,xx.Plan_province 
,case when xx.Plan_Territory Is Null then  emp.new_tmp_territoryname else  xx.Plan_Territory  end Plan_Territory
 ,xx.Plan_Accompany 
,xx.Visit_Number  ,xx.Visit_No ,xx.Visit_mark,NULL as Visit_Remark
,case when xx.Visit_Territory Is Null then  emp.new_tmp_territoryname else  xx.Visit_Territory  end Visit_Territory
,xx. Visitter,xx.Visitter1,xx.Plannerxxxxx
,xx.Visit_Date,xx.Visit_Period ,   xx.Visit_Time,xx.Visit_Activities,xx.Visit_Province	,xx.Visit_SupId	, xx.Visit_Accompany
,xx.new_coaching_day,xx.call_frequency,xx.coaching_call------->  All Coaching คือ call_frequency,coaching_call,coaching_day
, xx. Check_SupPlan ,xx.Check_PlanPeriod,xx.coaching_call1
,xx. CoachingDay 
,xx.CompletetinDate_WO
,xx.CompletetinDate_Rep	
,xx.Check_Complete
, xx.Time_Case_Complete
, xx.CompletetionDate  
, xx. Planner1
,xx.New_amt_coach_day,  xx.New_amt_coach_call,xx.New_amt_plan,xx.New_amt_visit,xx.New_day_exc,xx.New_day_inc,xx.New_target_coach_call,xx.New_target_coach_day,
xx.sm_name,xx.Completetion_Date
--,emp.new_tmp_territoryname
 from (
...
,data10.new_itinerary_resultid,data10.ownerid,data10.owner,data10.FormatDate,data10.Plan_Date ,data10.new_date     
,data10.Plan_Period  
...
,data9.new_itinerary_resultid,data9.ownerid,data9.owner,data9.FormatDate,data9.Plan_Date ,data9.new_date     
,data9.Plan_Period  
...
,data8.new_itinerary_resultid,data8.ownerid,data8.owner,data8.FormatDate,data8.Plan_Date ,data8.new_date     
,data8.Plan_Period  
...
emp.sm_name
from(
select  data7.new_itinerary_resultid,data7.ownerid,data7.owner,data7.FormatDate,data7.Plan_Date ,data7.new_date     
,data7.Plan_Period  
...
from(
select  data6.new_itinerary_resultid,data6.ownerid,data6.owner,data6.FormatDate,data6.Plan_Date ,data6.new_date     
,data6.Plan_Period  
...
from(
select  data5.new_itinerary_resultid,data5.ownerid,data5.owner,data5.FormatDate,data5.Plan_Date ,data5.new_date     
,data5.Plan_Period  
...
from(
select  data4.new_itinerary_resultid,data4.ownerid,data4.owner,data4.FormatDate,data4.Plan_Date ,data4.new_date     
,data4.Plan_Period  
...
from(
select  data3.new_itinerary_resultid,data3.ownerid,data3.owner,data3.FormatDate,data3.Plan_Date ,data3.new_date     
...
select  data2.new_itinerary_resultid,data2.ownerid,data2.owner,data2.FormatDate,data2.Plan_Date ,data2.new_date     ,data2.Plan_Period,data2.Plan_Time /*, data2.Plan_Activities*/
--,data2.Planner
...
from(
select  data1.new_itinerary_resultid,data1.ownerid,data1.owner,data1.FormatDate,data1.Plan_Date ,data1.new_date     ,data1.Plan_Period,data1.Plan_Time /*, data1.Plan_Activities*/
,data1.Planner
...
from(
select  data.new_itinerary_resultid,data.ownerid,data.owner,data.FormatDate,data.Plan_Date ,data.new_date     ,data.Plan_Period,data.Plan_Time /*, data.Plan_Activities*/
...
from(
select  tmp1.new_itinerary_resultid,tmp1.ownerid,tmp1.owner,tmp1.FormatDate,tmp1.Plan_Date ,tmp1.new_date   ,tmp1.Plan_Period,tmp1.Plan_Time /*, tmp1.Plan_Activities*/
...
from(
select  tmp.new_itinerary_resultid,tmp.ownerid,tmp.owner,tmp.FormatDate,tmp.Plan_Date, tmp.new_date,      tmp.Plan_Period,tmp.Plan_Time /*, tmp.Plan_Activities*/
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
select tdc2.Owner_List,tdc2.new_itinerary_resultid,tdc2.ownerid,tdc2.owner	,tdc2.FormatDate,tdc2.Plan_Date,tdc2.new_date,
...
from(
select tdc1.Owner_List,tdc1.new_itinerary_resultid,tdc1.ownerid,tdc1.owner	,tdc1.FormatDate,tdc1.Plan_Date,tdc1.new_date,
...
from(
select tdc.Owner_List,tdc.new_itinerary_resultid,tdc.ownerid,tdc.owner	,tdc.PlanDate	 as FormatDate,tdc.Plan_Date,tdc.new_date,
...
select tdcx.Owner_List,tdcx.new_itinerary_resultid,tdcx.ownerid ,tdcx.owner	,tdcx. FormatDate,tdcx.Plan_Date,tdcx.new_date,
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
select data_emp.Owner_List,data_emp.new_itinerary_resultid,data_emp.ownerid ,data_emp.owner	,data_emp. FormatDate,data_emp.Plan_Date,data_emp.new_date,
...
from 
(
select data.Owner_List,data.new_itinerary_resultid,data.ownerid ,data.owner	,data. FormatDate,data.Plan_Date,data.new_date,
...
group by  tmp1.new_itinerary_resultid,tmp1.ownerid,tmp1.owner,tmp1.FormatDate,tmp1.Plan_Date,tmp1.Plan_Period,tmp1.Plan_Time /*, tmp1.Plan_Activities*/
...
Left join 
(
select    new_tmp_territoryname , fullname,systemuserid  from FilteredSystemUser 
) emp  on xx.ownerid = emp.systemuserid